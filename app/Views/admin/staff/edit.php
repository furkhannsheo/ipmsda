...
<div class="form-group row">
    ...
    <div class="col-9">
        <input type="text" name="nama" class="form-control" placeholder="Nama staff" value="<?php echo isset($staff['nama']) ? $staff['nama'] : '' ?>" required>
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-6">
        <input type="text" name="jabatan" class="form-control" placeholder="Jabatan" value="<?php echo isset($staff['jabatan']) ? $staff['jabatan'] : '' ?>">
    </div>
    <div class="col-3">
        <input type="number" name="urutan" class="form-control" placeholder="No Urut tampil" value="<?php echo isset($staff['urutan']) ? $staff['urutan'] : '' ?>">
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-3">
        <input type="text" name="tempat_lahir" class="form-control" placeholder="Tempat lahir" value="<?php echo isset($staff['tempat_lahir']) ? $staff['tempat_lahir'] : '' ?>">
    </div>
    <div class="col-3">
...
<div class="form-group row">
    ...
    <div class="col-3">
        <select name="id_kategori_staff" class="form-control">
            <?php foreach($kategori_staff as $item) { ?>
            <option value="<?php echo $item['id_kategori_staff'] ?>" <?php if($staff['id_kategori_staff']==$item['id_kategori_staff']) { echo 'selected'; } ?>><?php echo $item['nama_kategori_staff'] ?></option>
            <?php } ?>
        </select>
